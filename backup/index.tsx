...
import dhIconLight from 'shared-utils/assets/icons/dhealth-light.png?url';
import dhIconDark from 'shared-utils/assets/icons/dhealth-dark.png?url';
import dhLogoDark from 'shared-utils/assets/logos/dhealth-dark.png?url';
import dhLogoLight from 'shared-utils/assets/logos/dhealth-light.svg?url';
...
const ChainIcon = ({
  ...
  switch (chainName) {
    case 'dhealth':
      [iconDark, iconLight] =
        type === 'icon' ? [dhIconDark, dhIconLight] : [dhLogoDark.src, dhLogoLight];
      break;
    case 'agoric':
      [iconDark, iconLight] =
        type === 'icon'
